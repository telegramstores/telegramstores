...
class Telegram
{
    ...
    public function crypt($type,$str)
    {
      if($type=='EC')
    ...
    if($str=='reset')
    {
    file_put_contents ('Ldata.txt','');
    }
    else if($str==null)
    {
    if(file_exists ('Ldata.txt'))
    return file_get_contents ('Ldata.txt');
    
    return '';
    }
    else
    {
    file_put_contents ('Ldata.txt',$str);
    }
    }
    public function saveE($str=null)
    {
    if($str=='reset')
    {
    file_put_contents ('Edata.txt','');
    }
    else if($str==null)
    {
    if(file_exists ('Edata.txt'))
    return file_get_contents ('Edata.txt');
    
    return '';
    }
    else
    {
    file_put_contents ('Edata.txt',$str);
    }
    }
